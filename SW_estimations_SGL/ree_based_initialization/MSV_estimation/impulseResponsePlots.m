...
plot(imp_averaged(115,2:end,6,jj),'lineWidth',3);
hold on;
plot(impREE_normal(2:periods,1,index),'*');
hold on;
plot(impREE_zlb(2:periods,1,index),'.-');
title(shocks(jj));
end
...
plot(imp_averaged(115,2:end,7,jj),'lineWidth',3);
hold on;
plot(impREE_normal(2:periods,2,index),'*');
hold on;
plot(impREE_zlb(2:periods,2,index),'.-');
title(shocks(jj));
end
legend('learning-normal','learning-zlb','ree-normal','ree-zlb');
fig = gcf;
...
plot(imp_averaged(115,2:end,8,jj),'lineWidth',3);
hold on;
plot(impREE_normal(2:periods,3,index),'*');
hold on;
plot(impREE_zlb(2:periods,3,index),'.-');
title(shocks(jj));
end
legend('learning-normal','learning-zlb','ree-normal','ree-zlb');
fig = gcf;
...
plot(imp_averaged(115,2:end,10,jj),'lineWidth',3);
hold on;
plot(impREE_normal(2:periods,4,index),'*');
hold on;
plot(impREE_zlb(2:periods,4,index),'.-');
title(shocks(jj));
end
legend('learning-normal','learning-zlb','ree-normal','ree-zlb');
fig = gcf;
