...
M_.param_names = char(M_.param_names, 'r_b');
M_.param_names_tex = char(M_.param_names_tex, 'r\_b');
M_.param_names_long = char(M_.param_names_long, 'r_b');
...
M_.params( 36 ) = 1.005;
cpie = M_.params( 36 );
M_.params( 37 ) = M_.params(28)*M_.params(51)^(-M_.params(21));
beta_bar = M_.params( 37 );
M_.params( 38 ) = M_.params(36)/(M_.params(28)*M_.params(51)^(-M_.params(21)));
cr = M_.params( 38 );
M_.params( 39 ) = M_.params(28)^(-1)*M_.params(51)^M_.params(21)-(1-M_.params(4));
crk = M_.params( 39 );
M_.params( 40 ) = (M_.params(9)^M_.params(9)*(1-M_.params(9))^(1-M_.params(9))/(M_.params(16)*M_.params(39)^M_.params(9)))^(1/(1-M_.params(9)));
cw = M_.params( 40 );
M_.params( 41 ) = 1-(1-M_.params(4))/M_.params(51);
cikbar = M_.params( 41 );
M_.params( 42 ) = M_.params(51)*(1-(1-M_.params(4))/M_.params(51));
cik = M_.params( 42 );
M_.params( 43 ) = (1-M_.params(9))/M_.params(9)*M_.params(39)/M_.params(40);
clk = M_.params( 43 );
M_.params( 44 ) = M_.params(16)*M_.params(43)^(M_.params(9)-1);
cky = M_.params( 44 );
M_.params( 45 ) = M_.params(42)*M_.params(44);
ciy = M_.params( 45 );
M_.params( 46 ) = 1-G-M_.params(42)*M_.params(44);
ccy = M_.params( 46 );
M_.params( 47 ) = M_.params(39)*M_.params(44);
crkky = M_.params( 47 );
M_.params( 48 ) = M_.params(44)*M_.params(39)*(1-M_.params(9))*1/M_.params(5)/M_.params(9)/M_.params(46);
cwhlc = M_.params( 48 );
M_.params( 49 ) = 1-M_.params(39)*M_.params(44);
cwly = M_.params( 49 );
M_.params( 10 ) = (M_.params(51)-1)*100;
gamma_bar = M_.params( 10 );
M_.params( 50 ) = 100*(M_.params(38)-1);
r_bar = M_.params( 50 );
M_.params( 7 ) = 100*(M_.params(36)-1);
pi_bar = M_.params( 7 );
M_.params( 6 ) = 0;
l_bar = M_.params( 6 );
%
...
estim_params_.param_vals = [estim_params_.param_vals; 22, 5, (-10), 10, 3, 2, 0.75, NaN, NaN, NaN ];
...
estim_params_.param_vals = [estim_params_.param_vals; 24, 1.7985, 1.0, 3, 3, 1.5, 0.25, NaN, NaN, NaN ];
estim_params_.param_vals = [estim_params_.param_vals; 27, 0.8258, 0.5, 0.975, 1, 0.75, 0.10, NaN, NaN, NaN ];
estim_params_.param_vals = [estim_params_.param_vals; 26, 0.0893, 0.001, 0.5, 3, 0.125, 0.05, NaN, NaN, NaN ];
estim_params_.param_vals = [estim_params_.param_vals; 25, 0.2239, 0.001, 0.5, 3, 0.125, 0.05, NaN, NaN, NaN ];
...
estim_params_.param_vals = [estim_params_.param_vals; 30, .2703, .01, .9999, 1, 0.5, 0.20, NaN, NaN, NaN ];
estim_params_.param_vals = [estim_params_.param_vals; 35, .9930, .01, .9999, 1, 0.5, 0.20, NaN, NaN, NaN ];
estim_params_.param_vals = [estim_params_.param_vals; 33, .5724, .01, .9999, 1, 0.5, 0.20, NaN, NaN, NaN ];
estim_params_.param_vals = [estim_params_.param_vals; 34, .3, .01, .9999, 1, 0.5, 0.20, NaN, NaN, NaN ];
estim_params_.param_vals = [estim_params_.param_vals; 31, .8692, .01, .9999, 1, 0.5, 0.20, NaN, NaN, NaN ];
estim_params_.param_vals = [estim_params_.param_vals; 32, .9546, .001, .9999, 1, 0.5, 0.20, NaN, NaN, NaN ];
...
options_.mode_file = 'SW_Estimation_REE_mode';
