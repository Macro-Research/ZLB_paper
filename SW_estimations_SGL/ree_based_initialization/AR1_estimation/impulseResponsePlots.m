clear;clc;%close all;
load('kf_output_workspace_october10.mat');
periods=50;
numPeriods=T;
...
%     index=index+1;
% subplot(3,2,index);
% plot(imp_averaged(160,1:end,6,jj),'--');
% hold on;
% plot(imp_averaged(180,1:end,6,jj),'lineWidth',3);
% hold on;
...
%     index=index+1;
% subplot(3,2,index);
% plot(imp_averaged(160,1:end,7,jj),'--');
% hold on;
% plot(imp_averaged(180,1:end,7,jj),'lineWidth',3);
% hold on;
...
impREE_zlb=impREE_zlb(2:end,:,:);impREE_normal=impREE_normal(2:end,:,:);
...
figure('Name','time varying impulse responses-consumption','Position',[610   428   700   525],'units','normalized','outerposition',[0 0 1 1]);
index=0;
for jj=[1 2 3 4 6 7]
    index=index+1;
subplot(3,2,index);
plot3(refLine1(2:end,1:end)',refLine2(2:end,1:end)',imp_averaged(2:end,1:end,6,jj));
hold on;
plot3(refLine1(1,1:end)',refLine2(1,1:end)',impREE_normal(1:end,1,index),'lineWidth',3,'color','black');
hold on
plot3(refLine1(end,1:end)',refLine2(end,1:end)',impREE_zlb(1:end,1,index),'lineWidth',3,'color','red');
...
for jj=[1 2 3 4 6 7]
    index=index+1;
subplot(3,2,index);
plot3(refLine1(2:end,1:end)',refLine2(2:end,1:end)',imp_averaged(2:end,1:end,7,jj));
hold on;
plot3(refLine1(1,1:end)',refLine2(1,1:end)',impREE_normal(1:end,2,index),'lineWidth',3,'color','black');
hold on
plot3(refLine1(end,1:end)',refLine2(end,1:end)',impREE_zlb(1:end,2,index),'lineWidth',3,'color','red');
...
plot(imp_averaged(180,1:end,6,jj),'lineWidth',3);
hold on;
plot(impREE_normal(1:end,1,index),'*');
hold on;
plot(impREE_zlb(1:end,1,index),'.-');
title(shocks(jj));
end
...
plot(imp_averaged(180,1:end,7,jj),'lineWidth',3);
hold on;
plot(impREE_normal(1:end,2,index),'*');
hold on;
plot(impREE_zlb(1:end,2,index),'.-');
title(shocks(jj));
end
legend('learning-normal','learning-zlb','ree-normal','ree-zlb');
fig = gcf;
...
%     index=index+1;
% subplot(3,2,index);
% cumul=cumsum(imp_averaged(160,1:end,6,jj));
% plot(cumul,'--');
% hold on;
% cumul=cumsum(imp_averaged(180,1:end,6,jj));
% plot(cumul,'lineWidth',3);
% hold on;
% cumul=cumsum(impREE_normal(1:end,1,index));
% plot(cumul,'*');
% hold on;
% cumul=cumsum(impREE_zlb(1:end,1,index));
% plot(cumul,'.-');
% title(shocks(jj));
% end
% legend('learning-normal','learning-zlb','ree-normal','ree-zlb');
...
%     index=index+1;
% subplot(3,2,index);
% cumul=cumsum(imp_averaged(160,1:end,7,jj));
% plot(cumul,'--');
% hold on;
% cumul=cumsum(imp_averaged(180,1:end,7,jj));
% plot(cumul,'lineWidth',3);
% hold on;
% cumul=cumsum(impREE_normal(1:end,2,index));
% plot(cumul,'*');
% hold on;
% cumul=cumsum(impREE_zlb(1:end,2,index));
% plot(cumul,'.-');
% title(shocks(jj));
% end
% legend('learning-normal','learning-zlb','ree-normal','ree-zlb');
...
%     index=index+1;
% subplot(3,2,index);
% cumul=cumsum(imp_averaged(160,1:end,8,jj));
% plot(cumul,'--');
% hold on;
% cumul=cumsum(imp_averaged(180,1:end,8,jj));
% plot(cumul,'lineWidth',3);
% hold on;
% cumul=cumsum(impREE_normal(1:end,3,index));
% plot(cumul,'*');
% hold on;
% cumul=cumsum(impREE_zlb(1:end,3,index));
% plot(cumul,'.-');
% title(shocks(jj));
% end
% legend('learning-normal','learning-zlb','ree-normal','ree-zlb');
...
%     index=index+1;
% subplot(3,2,index);
% cumul=cumsum(imp_averaged(160,1:end,10,jj));
% plot(cumul,'--');
% hold on;
% cumul=cumsum(imp_averaged(180,1:end,10,jj));
% plot(cumul,'lineWidth',3);
% hold on;
% cumul=cumsum(impREE_normal(1:end,4,index));
% plot(cumul,'*');
% hold on;
% cumul=cumsum(impREE_zlb(1:end,4,index));
% plot(cumul,'.-');
% title(shocks(jj));
% end
% legend('learning-normal','learning-zlb','ree-normal','ree-zlb');
