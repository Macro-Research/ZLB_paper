...
% function[likl]=KF_MS(parameters)
   %clear;clc;close all;
   % parameters=[0.24 0.65 1 0.0073 4.27 1.39 0.46 0.87 0.87 0.79 0.16 0.03 0.30 0.05 0.01 0.02 0.11 0.005];    
...
figure;
subplot(3,1,1);
plot(learning_filtered_alpha1(:,1),'lineWidth',3);
subplot(3,1,2);
plot(learning_filtered_alpha1(:,2),'lineWidth',3);
subplot(3,1,3);
plot(learning_filtered_alpha1(:,3),'lineWidth',3);

figure;
subplot(2,2,1);
plot(learning_filtered_beta1(:,1,1),'lineWidth',3);
subplot(2,2,2);
plot(learning_filtered_beta1(:,1,2),'lineWidth',3);
subplot(2,2,3);
plot(learning_filtered_beta1(:,2,1),'lineWidth',3);
subplot(2,2,4);
plot(learning_filtered_beta1(:,2,2),'lineWidth',3);

figure;
subplot(2,2,1);
plot(learning_filtered_cc1(:,1,1),'lineWidth',3);
subplot(2,2,2);
plot(learning_filtered_cc1(:,1,2),'lineWidth',3);
subplot(2,2,3);
plot(learning_filtered_cc1(:,2,1),'lineWidth',3);
subplot(2,2,4);
plot(learning_filtered_cc1(:,2,2),'lineWidth',3);
