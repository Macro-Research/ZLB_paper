function [residual, g1, g2, g3] = usmodel_noFlex_static(y, x, params)
%
...
T190 = 1/(1+params(44)*params(42)*params(21));
T204 = (1-params(22))*(1-params(44)*params(42)*params(22))/params(22)/(1+(params(18)-1)*params(3));
T212 = params(44)*params(42)/(1+params(44)*params(42));
T239 = (1-params(20))*(1-params(44)*params(42)*params(20))/((1+params(44)*params(42))*params(20))*1/(1+(params(24)-1)*params(1));
lhs =y(32);
...
residual(16)= lhs-rhs;
lhs =y(24);
rhs =y(33)*1/T60+(-y(31))+y(29)+params(47)/(params(47)+1-params(13))*y(22)+T71*y(24);
residual(17)= lhs-rhs;
lhs =y(25);
...
residual(20)= lhs-rhs;
lhs =y(29);
rhs =T190*(params(44)*params(42)*y(29)+y(29)*params(21)+y(20)*T204)+y(37);
residual(21)= lhs-rhs;
lhs =y(30);
rhs =T37*y(30)+y(30)*T212+y(29)*params(19)/(1+params(44)*params(42))-y(29)*(1+params(44)*params(42)*params(19))/(1+params(44)*params(42))+y(29)*T212+T239*(params(23)*y(28)+1/(1-T55)*y(25)-T55/(1-T55)*y(25)-y(30))+y(38);
residual(22)= lhs-rhs;
lhs =y(31);
rhs =y(29)*params(26)*(1-params(29))+(1-params(29))*params(28)*(y(27)-y(32)*params(18))+params(27)*(y(32)*params(18)+y(27)-y(32)*params(18)-y(27))+y(31)*params(29)+y(36);
residual(23)= lhs-rhs;
lhs =y(32);
...
T363 = 1-(T55/(1+T55)+1/(1+T55));
T365 = 1/(1-T55)-T55/(1-T55);
  g1(1,11)=(-params(9));
  g1(1,18)=(-(1-params(9)));
  g1(1,32)=1;
  g1(2,10)=1;
  ...
  g1(20,32)=(-params(18));
  g1(21,20)=(-(T190*T204));
  g1(21,29)=1-T190*(params(44)*params(42)+params(21));
  g1(21,37)=(-1);
  g1(22,25)=(-(T239*T365));
  g1(22,28)=(-(params(23)*T239));
  g1(22,29)=(-(T212+params(19)/(1+params(44)*params(42))-(1+params(44)*params(42)*params(19))/(1+params(44)*params(42))));
  g1(22,30)=1-(T37+T212-T239);
  g1(22,38)=(-1);
  g1(23,27)=(-((1-params(29))*params(28)));
  g1(23,29)=(-(params(26)*(1-params(29))));
  g1(23,31)=1-params(29);
  g1(23,32)=(-((1-params(29))*params(28)*(-params(18))));
  g1(23,36)=(-1);
