...
for jj=[1 2 3 4 6 7]
    index=index+1;
subplot(3,2,index);
plot(imp_averaged(175,2:end,6,jj),'--');
hold on;
plot(imp_averaged(203,2:end,6,jj),'lineWidth',3);
hold on;
...
for jj=[1 2 3 4 6 7]
    index=index+1;
subplot(3,2,index);
plot(imp_averaged(175,2:end,7,jj),'--');
hold on;
plot(imp_averaged(203,2:end,7,jj),'lineWidth',3);
hold on;
...
for jj=[1 2 3 4 6 7]
    index=index+1;
subplot(3,2,index);
plot(imp_averaged(175,2:end,8,jj),'--');
hold on;
plot(imp_averaged(203,2:end,8,jj),'lineWidth',3);
hold on;
...
for jj=[1 2 3 4 6 7]
    index=index+1;
subplot(3,2,index);
plot(imp_averaged(175,2:end,10,jj),'--');
hold on;
plot(imp_averaged(203,2:end,10,jj),'lineWidth',3);
hold on;
