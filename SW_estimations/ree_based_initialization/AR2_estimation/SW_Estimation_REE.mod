...
estimation(optim=('MaxIter',500),nograph,datafile=raf_dataset,mode_compute=1,first_obs=147,nobs=60,presample=4,kalman_algo=1,lik_init=2,prefilter=0,mh_replic=0,mh_nblocks=2,mh_jscale=0.3,mh_drop=0.2);
