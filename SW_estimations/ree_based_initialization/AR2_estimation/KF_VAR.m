...
%kalman block
S_fore11=gamma1_1*S_collapse1(:,tt-1)+gamma2_1+gamma4_1*S_collapse1(:,tt-2);%
S_fore12=gamma1_2*S_collapse1(:,tt-1)+gamma2_2+gamma4_2*S_collapse1(:,tt-2);%

S_fore12(12)=S_fore12(12)-E1(6)+E2(6);
S_fore21=gamma1_1*S_collapse2(:,tt-1)+gamma2_1+gamma4_1*S_collapse2(:,tt-2);%
S_fore22=gamma1_2*S_collapse2(:,tt-1)+gamma2_2+gamma4_2*S_collapse2(:,tt-2);%

S_fore22(12)=S_fore22(12)-E1(6)+E2(6);
%
P_fore11=gamma1_1*P_collapse1(:,:,tt-1)*gamma1_1'+gamma3_1*Sigma1*gamma3_1'+...
    gamma4_1*P_collapse1(:,:,tt-2)*gamma4_1';
P_fore12=gamma1_2*P_collapse1(:,:,tt-1)*gamma1_2'+gamma3_2*Sigma2*gamma3_2'+...
     gamma4_2*P_collapse1(:,:,tt-2)*gamma4_1';
P_fore21=gamma1_1*P_collapse2(:,:,tt-1)*gamma1_1'+gamma3_1*Sigma1*gamma3_1'+...
     gamma4_1*P_collapse2(:,:,tt-2)*gamma4_1';
P_fore22=gamma1_2*P_collapse2(:,:,tt-1)*gamma1_2'+gamma3_2*Sigma2*gamma3_2'+...
     gamma4_2*P_collapse2(:,:,tt-2)*gamma4_2';
%    
...
if pp_collapse1>10e-10;
    S_collapse1(:,tt)=(pp_upd11*S_upd11+pp_upd21*S_upd21)/pp_collapse1;
P_collapse1(:,:,tt)=(pp_upd11*(P_upd11+(S_collapse1(:,tt)-S_upd11)*(S_collapse1(:,tt)-S_upd11)')+...
    pp_upd21*(P_upd21+(S_collapse1(:,tt)-S_upd21)*(S_collapse1(:,tt)-S_upd21)'))/pp_collapse1;

else
    S_collapse1(:,tt)=(S_upd11+S_upd21)/2;
    P_collapse1(:,:,tt)=(P_upd11+P_upd21)/2;
 end

 if pp_collapse2>10e-10;
P_collapse2(:,:,tt)=(pp_upd12*(P_upd12+(S_collapse2(:,tt)-S_upd12)*(S_collapse2(:,tt)-S_upd12)')+...
    pp_upd22*(P_upd22+(S_collapse2(:,tt)-S_upd22)*(S_collapse2(:,tt)-S_upd22)'))/pp_collapse2;
S_collapse2(:,tt)=(pp_upd12*S_upd12+pp_upd22*S_upd22)/pp_collapse2;
  else
     S_collapse2(:,tt)=(S_upd12+S_upd22)/2;
     P_collapse2(:,:,tt)=(P_upd12+P_upd22)/2;
 end
