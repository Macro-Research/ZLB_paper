...
for jj=[1 2 3 4 6 7]
    index=index+1;
subplot(3,2,index);
plot3(refLine1(1:end,1:end)',refLine2(1:end,1:end)',imp_averaged(1:end,1:end,6,jj));
...
for jj=[1 2 3 4 6 7]
    index=index+1;
subplot(3,2,index);
plot3(refLine1(1:end,1:end)',refLine2(1:end,1:end)',imp_averaged(1:end,1:end,7,jj));
  ylim([startDate endDate])
   datetick('y','yyyy','keeplimits');
title(shocks(jj));
end
...
for jj=[1 2 3 4 6 7]
    index=index+1;
subplot(3,2,index);
plot3(refLine1(1:end,1:end)',refLine2(1:end,1:end)',imp_averaged(1:end,1:end,8,jj));
  ylim([startDate endDate])
   datetick('y','yyyy','keeplimits');
title(shocks(jj));
end
...
for jj=[1 2 3 4 6 7]
    index=index+1;
subplot(3,2,index);
plot3(refLine1(1:end,1:end)',refLine2(1:end,1:end)',imp_averaged(1:end,1:end,10,jj));
  ylim([startDate endDate])
   datetick('y','yyyy','keeplimits');
title(shocks(jj));
end
