...
title(shocks(jj));
view([115 8])
set(gca, 'CameraPosition', [425,766888,5]);
end
legend('normal','zlb','ree');
fig = gcf;
fig.PaperPositionMode = 'auto'
...
title(shocks(jj));
view([115 8])
set(gca, 'CameraPosition', [400,779444,0.25]);
end
legend('normal','zlb','ree');
fig = gcf;
fig.PaperPositionMode = 'auto'
...
impREE_zlb=impREE_zlb(2:51,:,:);impREE_normal=impREE_normal(2:51,:,:);
figure('Name','impulse responses-consumption','units','normalized','outerposition',[0 0 1 1]);
...
for jj=[1 2 3 4 6 7]
    index=index+1;
subplot(3,2,index);
plot(imp_averaged(90,1:end,6,jj),'--');
hold on;
plot(imp_averaged(115,1:end,6,jj),'lineWidth',3);
hold on;
...
for jj=[1 2 3 4 6 7]
    index=index+1;
subplot(3,2,index);
plot(imp_averaged(90,1:end,7,jj),'--');
hold on;
plot(imp_averaged(115,1:end,7,jj),'lineWidth',3);
hold on;
...
for jj=[1 2 3 4 6 7]
    index=index+1;
subplot(3,2,index);
plot(imp_averaged(90,1:end,8,jj),'--');
hold on;
plot(imp_averaged(115,1:end,8,jj),'lineWidth',3);
hold on;
...
for jj=[1 2 3 4 6 7]
    index=index+1;
subplot(3,2,index);
plot(imp_averaged(90,1:end,10,jj),'--');
hold on;
plot(imp_averaged(115,1:end,10,jj),'lineWidth',3);
hold on;
