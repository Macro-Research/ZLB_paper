...
S_fore12(19)=S_fore12(19)-E1(6);%break in the intercept of b-shock
S_fore21=gamma1_1*S_collapse2+gamma2_1;%
S_fore22=gamma1_2*S_collapse2+gamma2_2;%
%S_fore22(19)=S_fore22(18)-1.38;
S_fore22(19)=S_fore22(19)-E1(6);% break in the intercept of b-shock
%
...
catch largest_eig1(tt)=1.01;end

    try
largest_eig2(tt)=abs(eigs(gamma1_2,1));
    catch largest_eig2(tt)=1.01;end
