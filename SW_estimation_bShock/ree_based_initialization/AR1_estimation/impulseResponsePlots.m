...
hold on;
plot(imp_averaged(180,2:end,6,jj),'lineWidth',3);
hold on;
...
hold on;
plot(imp_averaged(180,2:end,7,jj),'lineWidth',3);
hold on;
...
hold on;
plot(imp_averaged(180,2:end,8,jj),'lineWidth',3);
hold on;
...
hold on;
plot(imp_averaged(180,2:end,10,jj),'lineWidth',3);
hold on;
...
for jj=[1 2 3 4 6 7]
    index=index+1;
subplot(3,2,index);
cumul=cumsum(imp_averaged(160,2:end,6,jj));
plot(cumul,'--');
hold on;
cumul=cumsum(imp_averaged(180,2:end,6,jj));
...
for jj=[1 2 3 4 6 7]
    index=index+1;
subplot(3,2,index);
cumul=cumsum(imp_averaged(160,2:end,7,jj));
plot(cumul,'--');
hold on;
cumul=cumsum(imp_averaged(180,2:end,7,jj));
plot(cumul,'lineWidth',3);
hold on;
...
for jj=[1 2 3 4 6 7]
    index=index+1;
subplot(3,2,index);
cumul=cumsum(imp_averaged(160,2:end,8,jj));
plot(cumul,'--');
hold on;
cumul=cumsum(imp_averaged(180,2:end,8,jj));
plot(cumul,'lineWidth',3);
hold on;
...
for jj=[1 2 3 4 6 7]
    index=index+1;
subplot(3,2,index);
cumul=cumsum(imp_averaged(160,2:end,10,jj));
plot(cumul,'--');
hold on;
cumul=cumsum(imp_averaged(180,2:end,10,jj));
plot(cumul,'lineWidth',3);
hold on;
