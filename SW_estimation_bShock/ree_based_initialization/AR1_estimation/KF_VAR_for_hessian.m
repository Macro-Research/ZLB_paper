function[likl,likl_incremental]=KF_VAR_for_hessian(param)
...
load('raf_dataset.mat');first_obs=127;last_obs=length(dy);
...
gamma1_1=AA1_inv*(BB1+CC1*beta1^2);gamma2_1=AA1_inv*CC1*(eye(numVar)-beta1^2)*alpha1;gamma3_1=AA1_inv*DD1;%gamma4_1=AA1_inv*EE1;
gamma1_2=AA2_inv*(BB2+CC2*beta1^2);gamma2_2=AA2_inv*CC2*(eye(numVar)-beta1^2)*alpha1;gamma3_2=AA1_inv*DD2;%gamma4_2=AA2_inv*EE2;
