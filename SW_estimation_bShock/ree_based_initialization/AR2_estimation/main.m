...
% init_H1=nearestSPD(inv(diag(diag(init_H1))));
 ...
 %load('init_H1.mat');
 %init_H1=nhess_diagonal(@likelihood,param_init);
 %init_H1=inv(init_H1);init_H1=diag(diag(init_H1));
 %save init_H1.mat init_H1;
 load('init_H1.mat')
[fh,x,gh,H,itct,fcount,retcodeh] = csminwel('likelihood',param_init,init_H1,[] ,10^(-4),9999);% laplace_=laplace_approximator(fh,x,H);
