...
% alpha_tt(:,tt-1)=alpha1(1:3);
% beta_tt(:,tt-1)=beta1(1:3,3);
% cc_tt(:,:,tt-1)=cc1;
...
print(fig,'NKPC_ree_init_MSV_regime','-dpdf');
...
fig_pos = fig.PaperPosition;
fig.PaperSize = [fig_pos(3) fig_pos(4)];
print(fig,'NKPC_ree_init_MSV_regimeProb','-dpdf');
...
fig_pos = fig.PaperPosition;
fig.PaperSize = [fig_pos(3) fig_pos(4)];
print(fig,'NKPC_ree_init_MSV_alphas','-dpdf');
...
fig_pos = fig.PaperPosition;
fig.PaperSize = [fig_pos(3) fig_pos(4)];
print(fig,'NKPC_ree_init_MSV_betas','-dpdf');
...
fig_pos = fig.PaperPosition;
fig.PaperSize = [fig_pos(3) fig_pos(4)];
print(fig,'NKPC_ree_init_MSV_shockCoef','-dpdf');
