...
Date=linspace(startDate,endDate,length(dataset)-1);
...
[alpha_y_init,alpha_pinf_init,beta_y_init,beta_pinf_init,...
    rr_y_init,rr_pinf_init]=belief_initialization(parameters,dataset);

alpha1(1)=alpha_y_init;alpha1(2)=alpha_pinf_init;
beta1(1,1)=beta_y_init;beta1(2,2)=beta_pinf_init;
rr(:,:,1)=rr_y_init;
rr(:,:,2)=rr_pinf_init;
...
print(fig,'NKPC_filter_init_AR1_regime','-dpdf');
...
fig_pos = fig.PaperPosition;
fig.PaperSize = [fig_pos(3) fig_pos(4)];
print(fig,'NKPC_filter_init_AR1_regimeProb','-dpdf');
...
fig_pos = fig.PaperPosition;
fig.PaperSize = [fig_pos(3) fig_pos(4)];
print(fig,'NKPC_filter_init_AR1_alphas','-dpdf');
...
fig_pos = fig.PaperPosition;
fig.PaperSize = [fig_pos(3) fig_pos(4)];
print(fig,'NKPC_filter_init_AR1_betas','-dpdf');
