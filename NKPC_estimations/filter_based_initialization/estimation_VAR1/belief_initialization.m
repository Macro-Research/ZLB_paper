function[alpha_init,beta_init,rr_init]=belief_initialization(parameters,dataset);
% clear;clc;close all;
...
alpha1=0*ones(numVar,1);beta1=0*eye(numVar);rr=1*eye(4);
...
alpha_init=alpha1(1:3);
beta_init=beta1(1:3,1:3);
rr_init=rr;
% 
end
