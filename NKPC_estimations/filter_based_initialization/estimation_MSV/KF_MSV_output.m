...
parameters=x;
%clear;clc;close all;
%parameters=[-0.1 0.4 0.75 0.01 2.66 1.51 0.33 0.9 0.9 0.85 0.13 0.3 0.3 0.03 0.01 0.02 0.13 0.004];    
   gain=parameters(18);
%  q_11=0.99;q_22=0.85; 
...
[alpha1,beta1(:,3),cc1,rr]=...
    belief_initialization(parameters,dataset);
% beta1(:,3)=[-0.64;0.4;0.73];
% cc1=[4.52,-1.6;0.2,0.9;0.07,0.18];
% 
% rr=eye(4);
% rr=eye(4);load('ree_based_initials.mat');
% beta1(:,3)=beta_init(:,3);
% cc1=cc_init;
