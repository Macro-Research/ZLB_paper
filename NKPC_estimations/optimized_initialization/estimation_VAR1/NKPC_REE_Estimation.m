...
M_.endo_names = char(M_.endo_names, 'gap_hp');
M_.endo_names_tex = char(M_.endo_names_tex, 'gap\_hp');
M_.endo_names_long = char(M_.endo_names_long, 'gap_hp');
...
estim_params_.param_vals = [estim_params_.param_vals; 14, 0.95, 0, 0.9999, 3, 0.65, 1, NaN, NaN, NaN ];
estim_params_.param_vals = [estim_params_.param_vals; 15, 0, (-0.9999), 0.9999, 3, 0.51, 1, NaN, NaN, NaN ];
estim_params_.param_vals = [estim_params_.param_vals; 16, 0, (-0.9999), 0.9999, 3, 0.31, 1, NaN, NaN, NaN ];
estim_params_.param_vals = [estim_params_.param_vals; 17, 0, (-0.9999), 0.9999, 3, (-0.05), 1, NaN, NaN, NaN ];
estim_params_.param_vals = [estim_params_.param_vals; 18, 0.95, NaN, 0.9999, 3, 0.89, 1, NaN, NaN, NaN ];
estim_params_.param_vals = [estim_params_.param_vals; 19, 0, (-0.9999), 0.9999, 3, 0.08, 1, NaN, NaN, NaN ];
estim_params_.param_vals = [estim_params_.param_vals; 20, 0, (-0.9999), 0.9999, 3, 0.01, 1, NaN, NaN, NaN ];
estim_params_.param_vals = [estim_params_.param_vals; 21, 0, (-0.9999), 0.9999, 3, 0.25, 1, NaN, NaN, NaN ];
estim_params_.param_vals = [estim_params_.param_vals; 22, 0.95, 0, 0.9999, 3, 0.51, 1, NaN, NaN, NaN ];
