...
load('VAR1_initial_beliefs.mat');
alpha1(1:3,1)=alpha_init;
...
print(fig,'NKPC_optim_init_VAR1_regime','-dpdf');
...
fig_pos = fig.PaperPosition;
fig.PaperSize = [fig_pos(3) fig_pos(4)];
print(fig,'NKPC_optim_init_VAR1_regimeProb','-dpdf');
...
fig_pos = fig.PaperPosition;
fig.PaperSize = [fig_pos(3) fig_pos(4)];
print(fig,'NKPC_optim_init_VAR1_alphas','-dpdf');
...
fig_pos = fig.PaperPosition;
fig.PaperSize = [fig_pos(3) fig_pos(4)];
print(fig,'NKPC_optim_init_VAR1_betas','-dpdf');
