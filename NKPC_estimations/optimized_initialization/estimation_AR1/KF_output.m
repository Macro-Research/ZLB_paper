...
beta1(1,1)=beta_init(1);beta1(2,2)=beta_init(2);
rr(:,:,1)=rr_y;
rr(:,:,2)=rr_pinf;
...
print(fig,'NKPC_optim_init_AR1_regime','-dpdf');
...
fig_pos = fig.PaperPosition;
fig.PaperSize = [fig_pos(3) fig_pos(4)];
print(fig,'NKPC_optim_init_AR1_regimeProb','-dpdf');
...
fig_pos = fig.PaperPosition;
fig.PaperSize = [fig_pos(3) fig_pos(4)];
print(fig,'NKPC_optim_init_AR1_alphas','-dpdf');
...
fig_pos = fig.PaperPosition;
fig.PaperSize = [fig_pos(3) fig_pos(4)];
print(fig,'NKPC_optim_init_AR1_betas','-dpdf');
