...
alpha_y alpha_pinf beta_y beta_pinf;
...
alpha_y,0,-5,5,NORMAL_PDF,0,1; 
alpha_pinf,0,-5,5,NORMAL_PDF,0,1;
beta_y,0.95,0,0.9999,NORMAL_PDF,0.93,1;
beta_pinf,0.95,0,0.9999,NORMAL_PDF,0.7,1;
end;
varobs gap_cbo pinfobs robs;

model(linear);
#beta=0.99;
#y_forecast=(alpha_y+beta_y*alpha_y)+beta_y^2*y(-1);
#pinf_forecast=(alpha_pinf+beta_pinf*alpha_pinf)+beta_pinf^2*pi(-1);
