...
parameters=x;
%clear;clc;close all;
%parameters=[0.24 0.65 1 0.01 4.27 1.39 0.46 0.85 0.85 0.95 0.16 0.03 0.3 0.1 0.05 0.02 0.11 0.001];    
   gain=parameters(18);
%  q_11=0.99;q_22=0.85; 
...
print(fig,'NKPC_optim_init_MSV_regime','-dpdf');
...
fig_pos = fig.PaperPosition;
fig.PaperSize = [fig_pos(3) fig_pos(4)];
print(fig,'NKPC_optim_init_MSV_regimeProb','-dpdf');
...
fig_pos = fig.PaperPosition;
fig.PaperSize = [fig_pos(3) fig_pos(4)];
print(fig,'NKPC_optim_init_MSV_alphas','-dpdf');
...
fig_pos = fig.PaperPosition;
fig.PaperSize = [fig_pos(3) fig_pos(4)];
print(fig,'NKPC_optim_init_MSV_betas','-dpdf');
...
fig_pos = fig.PaperPosition;
fig.PaperSize = [fig_pos(3) fig_pos(4)];
print(fig,'NKPC_optim_init_MSV_shockCoef','-dpdf');
