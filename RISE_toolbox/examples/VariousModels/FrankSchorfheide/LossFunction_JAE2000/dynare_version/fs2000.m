...
estim_params_.param_vals = [estim_params_.param_vals; 1, NaN, (-Inf), Inf, 1, 0.356000, 0.02, NaN, NaN, NaN ];
estim_params_.param_vals = [estim_params_.param_vals; 2, NaN, (-Inf), Inf, 1, 0.993000, 0.002, NaN, NaN, NaN ];
estim_params_.param_vals = [estim_params_.param_vals; 3, NaN, (-Inf), Inf, 3, 0.008500, 0.003, NaN, NaN, NaN ];
estim_params_.param_vals = [estim_params_.param_vals; 4, NaN, (-Inf), Inf, 3, 1.000200, 0.007, NaN, NaN, NaN ];
estim_params_.param_vals = [estim_params_.param_vals; 5, NaN, (-Inf), Inf, 1, 0.129000, 0.223, NaN, NaN, NaN ];
estim_params_.param_vals = [estim_params_.param_vals; 6, NaN, (-Inf), Inf, 1, 0.650000, 0.05, NaN, NaN, NaN ];
estim_params_.param_vals = [estim_params_.param_vals; 7, NaN, (-Inf), Inf, 1, 0.010000, 0.005, NaN, NaN, NaN ];
...
options_.order = 1;
var_list_ = char('m','P','c','e','W','R','k','d','n','l');
...
if exist('dataset_info', 'var') == 1
  save('fs2000_results.mat', 'dataset_info', '-append');
end
if exist('oo_recursive_', 'var') == 1
  save('fs2000_results.mat', 'oo_recursive_', '-append');
end
