function [w,yhat,fcast_error]=mgnldnsty(ydata_original,lags,xdata_original,breaks,lambda,mu,mnprior,vprior,train,flat,startfor,forecastperiod)
...
ydata=ydata_original(1:startfor-1,:);
xdata=xdata_original(1:startfor-1,:);
...
% =========================================================================
yhat = sims_fcast(ydata(end-lags+1:end,:),var.By,var.Bx,xdata_original(startfor-lags:startfor+forecastperiod-1,:),forecastperiod);
fcast_error=yhat(1:forecastperiod,:)-ydata_original(startfor:startfor+forecastperiod-1,:);
% =========================================================================
