function [alphahat,etahat,a, aK, filteratt] = DiffuseKalmanSmoother1(T,R,Q,Pinf1,Pstar1,Y,trend,pp,mm,smpl,mf)
% modified by M. Ratto:
...
while t<smpl
    ...
    a(:,t+1) = T*a(:,t) + K_s*v(:,t);
    %-------------------------------------------------- 
    filteratt(:,t)=a(:,t) + KwithoutT_s*v(:,t);
    %-------------------------------------------------- 
    aK(1,:,t+1) 	 	= a(:,t+1);
    for jnk=2:nk,
        aK(jnk,:,t+jnk) 	 	= T^(jnk-1)*a(:,t+1);
