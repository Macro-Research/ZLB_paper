...
parameters  curvw cgy curvp constelab constepinf constebeta   calfa 
            ...
            ctrend conster cg cgamma clandap cbetabar cr cpie crk cw cikbar cik clk cky ciy ccy crkky cwhlc cwly ro;
...
csadjcost,6.3325,1,15,NORMAL_PDF,4,1.5;
...
estimation(optim=('MaxIter',200),datafile=usmodel_data_SW_data_april2009,mode_compute=0,mode_file=T_AR2_mode,first_obs=71,presample=4,kalman_algo=603,lik_init=2,prefilter=0,mh_replic=0,mh_nblocks=2,mh_jscale=0.23,mh_drop=0.2);
//estimation(optim=('MaxIter',200),datafile=usmodel_data_SW_data_april2009,mode_compute=1,mode_file=T_5Mod_no4_EW_oldfile_newdata_176_mode,first_obs=71,presample=4,nobs=176,kalman_algo=603,lik_init=2,prefilter=0,mh_replic=200000,mh_nblocks=2,mh_jscale=0.13,mh_drop=0.1,nodiagnostic);
