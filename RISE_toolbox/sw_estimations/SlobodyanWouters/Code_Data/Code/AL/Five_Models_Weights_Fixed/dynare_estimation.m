...
m1 = {'inve',{'inve'},{};'c',{'c'},{};'lab',{'lab'},{};'w',{'w'},{};'pinf',{'pinf'},{};...
    'pk',{'pk'},{};'rk',{'rk'},{};};
% AR(2) + 2 ('pinf' and 'r') Model
m2 = {'inve',{'inve','invel','pinf','r'},{};'c',{'c','cl','pinf','r'},{};'lab',{'lab','labl','pinf','r'},{};'pinf',{'pinf','pinfl','r'},{};...
    'pk',{'pk','pkl','pinf','r'},{};'rk',{'rk','rkl','pinf','r'},{};'w',{'w','wl','pinf','r'},{};};
% AR(2) Model
m3 = {'inve',{'inve','invel'},{};'c',{'c','cl'},{};'lab',{'lab','labl'},{};'pinf',{'pinf','pinfl'},{};...
    'pk',{'pk','pkl'},{};'rk',{'rk','rkl'},{};'w',{'w','wl'},{};};
% AR(2) + 1 ('pinf') Model
m4 = {'inve',{'inve','invel','pinf'},{};'c',{'c','cl','pinf'},{};'lab',{'lab','labl','pinf'},{};'pinf',{'pinf','pinfl'},{};...
    'pk',{'pk','pkl','pinf'},{};'rk',{'rk','rkl','pinf'},{};'w',{'w','wl','pinf'},{};};
% AR(1) + 3 model
m5 = {'inve',{'inve','invel','pinf','y','r'},{};'c',{'c','cl','pinf','y','r'},{};'lab',{'lab','labl','pinf','y','r'},{};'pinf',{'pinf','pinfl','y','r'},{};...
    'pk',{'pk','pkl','pinf','y','r'},{};'rk',{'rk','rkl','pinf','y','r'},{};'w',{'w','wl','pinf','y','r'},{};};
