...
estimation(optim=('MaxIter',200),datafile=usmodel_data_SW_data_april2009,mode_compute=0,mode_file=T_5Mod_no4_BIC_mode,first_obs=71,presample=4,kalman_algo=603,lik_init=2,prefilter=0,mh_replic=0,mh_nblocks=2,mh_jscale=0.13,mh_drop=0.2);
