...
M_.endo_names = char(M_.endo_names, 'AUX_EXO_LAG_67_0');
M_.endo_names_tex = char(M_.endo_names_tex, 'AUX\_EXO\_LAG\_67\_0');
M_.endo_names_long = char(M_.endo_names_long, 'AUX_EXO_LAG_67_0');
M_.endo_names = char(M_.endo_names, 'AUX_EXO_LAG_68_0');
M_.endo_names_tex = char(M_.endo_names_tex, 'AUX\_EXO\_LAG\_68\_0');
M_.endo_names_long = char(M_.endo_names_long, 'AUX_EXO_LAG_68_0');
...
estim_params_.param_vals = [estim_params_.param_vals; 16, 0.57, 0.3, 0.99, 1, 0.5, 0.1, NaN, NaN, NaN ];
estim_params_.param_vals = [estim_params_.param_vals; 20, 0.96, 0.25, 10, 3, 2, 0.75, NaN, NaN, NaN ];
estim_params_.param_vals = [estim_params_.param_vals; 18, 0.9, 0.5, 0.99, 1, 0.5, 0.1, NaN, NaN, NaN ];
estim_params_.param_vals = [estim_params_.param_vals; 15, 0.3, 0.01, 0.99, 1, 0.5, 0.15, NaN, NaN, NaN ];
estim_params_.param_vals = [estim_params_.param_vals; 17, 0.65, 0.01, 0.99, 1, 0.5, 0.15, NaN, NaN, NaN ];
...
estim_params_.param_vals = [estim_params_.param_vals; 32, 0.5, 0, .999999, 1, 0.5, 0.2, NaN, NaN, NaN ];
...
estim_params_.param_vals = [estim_params_.param_vals; 34, 0.5, 0, .99, 1, 0.5, 0.2, NaN, NaN, NaN ];
estim_params_.param_vals = [estim_params_.param_vals; 33, 0.5, 0, .99, 1, 0.5, 0.2, NaN, NaN, NaN ];
estim_params_.param_vals = [estim_params_.param_vals; 31, 0.5, 0, .99, 1, 0.5, 0.25, NaN, NaN, NaN ];
