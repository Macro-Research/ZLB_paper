...
options_ = [];
M_.fname = 'SmetsBenchmarkEstimation';
...
diary off;
diary('SmetsBenchmarkEstimation.log');
M_.exo_names = 'eta_a';
...
M_.param_names = 'PI_star';
M_.param_names_tex = 'PI\_star';
M_.param_names_long = 'PI_star';
...
M_.param_names = char(M_.param_names, 'I_K_bar');
M_.param_names_tex = char(M_.param_names_tex, 'I\_K\_bar');
M_.param_names_long = char(M_.param_names_long, 'I_K_bar');
M_.param_names = char(M_.param_names, 'I_K');
M_.param_names_tex = char(M_.param_names_tex, 'I\_K');
M_.param_names_long = char(M_.param_names_long, 'I_K');
...
M_.param_names = char(M_.param_names, 'Z_Y');
M_.param_names_tex = char(M_.param_names_tex, 'Z\_Y');
M_.param_names_long = char(M_.param_names_long, 'Z_Y');
M_.param_names = char(M_.param_names, 'WL_C');
M_.param_names_tex = char(M_.param_names_tex, 'WL\_C');
...
M_.param_names = char(M_.param_names, 'curv_w');
M_.param_names_tex = char(M_.param_names_tex, '\eps_w');
M_.param_names_long = char(M_.param_names_long, 'curv_w');
...
erase_compiled_function('SmetsBenchmarkEstimation_static');
erase_compiled_function('SmetsBenchmarkEstimation_dynamic');
M_.orig_eq_nbr = 28;
M_.eq_nbr = 28;
M_.ramsey_eq_nbr = 0;
...
pi_bar = M_.params( 22 );
M_.params( 23 ) = 0.1201;
beta_const = M_.params( 23 );
M_.params( 21 ) = 1.0740;
l_bar = M_.params( 21 );
M_.params( 25 ) = 0.3005;
gamma_bar = M_.params( 25 );
M_.params( 24 ) = 0.1671;
alpha = M_.params( 24 );
M_.params( 40 ) = 0.9872;
rho_a = M_.params( 40 );
...
M_.Sigma_e(2, 2) = (0.1900)^2;
M_.Sigma_e(3, 3) = (0.3971)^2;
M_.Sigma_e(4, 4) = (0.2868)^2;
M_.Sigma_e(5, 5) = (0.1141)^2;
M_.Sigma_e(6, 6) = (0.1082)^2;
M_.Sigma_e(7, 7) = (0.4205)^2;
M_.params( 1 ) = 1+M_.params(22)/100;
PI_star = M_.params( 1 );
M_.params( 2 ) = 1+M_.params(25)/100;
gamma = M_.params( 2 );
M_.params( 3 ) = 1/(1+M_.params(23)/100);
beta = M_.params( 3 );
M_.params( 4 ) = M_.params(3)*M_.params(2)^(-M_.params(34));
beta_bar = M_.params( 4 );
M_.params( 5 ) = M_.params(3)^(-1)*M_.params(2)^M_.params(34)-(1-M_.params(19));
Rk = M_.params( 5 );
M_.params( 6 ) = (M_.params(24)^M_.params(24)*(1-M_.params(24))^(1-M_.params(24))/(M_.params(29)*M_.params(5)^M_.params(24)))^(1/(1-M_.params(24)));
W = M_.params( 6 );
M_.params( 7 ) = 1-(1-M_.params(19))/M_.params(2);
I_K_bar = M_.params( 7 );
M_.params( 8 ) = M_.params(2)*(1-(1-M_.params(19))/M_.params(2));
I_K = M_.params( 8 );
M_.params( 9 ) = (1-M_.params(24))/M_.params(24)*M_.params(5)/M_.params(6);
L_K = M_.params( 9 );
M_.params( 10 ) = M_.params(29)*M_.params(9)^(M_.params(24)-1);
K_Y = M_.params( 10 );
M_.params( 11 ) = M_.params(8)*M_.params(10);
I_Y = M_.params( 11 );
M_.params( 12 ) = 1-M_.params(18)-M_.params(8)*M_.params(10);
C_Y = M_.params( 12 );
M_.params( 13 ) = M_.params(5)*M_.params(10);
Z_Y = M_.params( 13 );
M_.params( 14 ) = M_.params(10)*M_.params(5)*(1-M_.params(24))*1/M_.params(20)/M_.params(24)/M_.params(12);
WL_C = M_.params( 14 );
M_.params( 15 ) = 100*(M_.params(1)/(M_.params(3)*M_.params(2)^(-M_.params(34)))-1);
r_bar = M_.params( 15 );
save('SmetsBenchmarkEstimation_results.mat', 'oo_', 'M_', 'options_');
if exist('estim_params_', 'var') == 1
  save('SmetsBenchmarkEstimation_results.mat', 'estim_params_', '-append');
end
if exist('bayestopt_', 'var') == 1
  save('SmetsBenchmarkEstimation_results.mat', 'bayestopt_', '-append');
end
if exist('dataset_', 'var') == 1
  save('SmetsBenchmarkEstimation_results.mat', 'dataset_', '-append');
end
if exist('estimation_info', 'var') == 1
  save('SmetsBenchmarkEstimation_results.mat', 'estimation_info', '-append');
end
if exist('dataset_info', 'var') == 1
  save('SmetsBenchmarkEstimation_results.mat', 'dataset_info', '-append');
end
if exist('oo_recursive_', 'var') == 1
  save('SmetsBenchmarkEstimation_results.mat', 'oo_recursive_', '-append');
end
