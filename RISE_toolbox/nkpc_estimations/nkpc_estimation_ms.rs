...
parameters beta y_bar pi_bar kappa tau rho_y rho_pi sig_pi sig_y r_bar 
parameters(coef,2) phi_pi phi_y rho_r sig_r czlb
...
r=rho_r*r(-1)+(1-rho_r)*(phi_pi*pinf+phi_y*y)+sig_r*eps_r-czlb*(1-rho_r)*(r_bar-0.03);
