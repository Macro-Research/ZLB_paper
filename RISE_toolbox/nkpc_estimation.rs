...
parameters beta y_bar pi_bar kappa tau rho_y rho_pi sig_pi sig_y r_bar phi_pi phi_y rho_r sig_r
...
r_bar,1.05,0.5,0.25,gamma_pdf;
//r_bar(coef,2),0.01,0,0.1,normal_pdf;
kappa,0.0073,0.3,0.15,beta_pdf;
tau,4,2,0.5,gamma_pdf;
phi_pi,1.4,1.5,0.25,gamma_pdf;
//phi_pi(coef,2),0;
phi_y,0.46,0.5,0.25,gamma_pdf;
//phi_y(coef,2),0;
rho_y,0.87,0.5,0.2,beta_pdf;
rho_pi,0.87,0.5,0.2,beta_pdf;
rho_r,0.79,0.5,0.2,beta_pdf;
//rho_r(coef,2),0;
sig_y,0.16,0.1,2,inv_gamma_pdf;
sig_pi,0.03,0.1,2,inv_gamma_pdf;
sig_r,0.30,0.1,2,inv_gamma_pdf;
//sig_r(coef,2),0.3,0.1,2,inv_gamma_pdf;
beta,0.99;
