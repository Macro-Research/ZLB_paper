...
fs1=-mc + alpha*rk + (1-alpha)*w - eps_a==0;
    ...
    Contemp = [mc,zcap,rk,k_s,q,c,i1,y,l,pinf,w,r,k...
               eps_a,eps_b,eps_g,eps_i,eps_r,eps_p,eps_w ];
           
     Expectation=[ mcp,zcapp,rkp,k_sp,qp,cp,ip,yp,lp,pinfp,wp,rp,kp...
         epsp_a,epsp_b,epsp_g,epsp_i,epsp_r,epsp_p,epsp_w];
     
     Lagged=[ mcm ,zcapm ,rkm, k_sm ,qm, cm ,im ,ym, lm ,pinfm ,wm ,rm ,km...
         epsm_a,epsm_b,epsm_g,epsm_i,epsm_r,epsm_p,epsm_w];
