...
% H=inv(H);
 %init_H3=nhess_diagonal(@likelihood,param_init');init_H3=inv(init_H3);
 %save init_H3.mat init_H3;
load('init_H3.mat')
%load('init_H1.mat');
%load init_H3.mat ;
%load('init_H_subSample.mat');

[fh,x,gh,H,itct,fcount,retcodeh] = csminwel('likelihood',param_init',init_H3,[] ,10^(-5),9999);% laplace_=laplace_approximator(fh,x,H);
