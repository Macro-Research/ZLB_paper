...
% init_H1=nearestSPD(inv(diag(diag(init_H1))));
 ...
 %load('init_H1.mat');
 %init_H_fullSample2=nhess_diagonal(@likelihood,param_init);
 %init_H_fullSample2=inv(init_H_fullSample2);init_H_fullSample2=diag(diag(init_H_fullSample2));
 %save init_H_fullSample2.mat init_H_fullSample2;
 load('init_H_fullSample2.mat')
[fh,x,gh,H,itct,fcount,retcodeh] = csminwel('likelihood',param_init,init_H_fullSample2,[] ,10^(-4),9999);% laplace_=laplace_approximator(fh,x,H);
