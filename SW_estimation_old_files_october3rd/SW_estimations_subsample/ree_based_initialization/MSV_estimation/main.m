...
% H=inv(H);
 %init_H_fullSample=nhess_diagonal(@likelihood,param_init');init_H_fullSample=inv(init_H_fullSample);
 %save init_H_fullSample.mat init_H_fullSample;
 load('init_H_fullSample.mat');
%load init_H3.mat ;
[fh,x,gh,H,itct,fcount,retcodeh] = csminwel('likelihood',param_init',init_H_fullSample,[] ,10^(-5),9999);% laplace_=laplace_approximator(fh,x,H);
