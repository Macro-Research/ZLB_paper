...
parameters=[0 0 0 0.01 3 1.5 0.5 0.5 0.5 0.9 0.7 0.3 0.3 0 0.01 0.01 0.10 0.01];    
...
vec_dd=(eye(m_states*2)-kron(eye(m_states-1),C_tilde*bb)-kron(RHO_tilde',C_tilde))^(-1)*vec(D_tilde); 
dd=reshape(vec_dd,[3 2]); 
aa=zeros(m_states,1);
