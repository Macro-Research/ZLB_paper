...
%calibration
sigma=3; kappa=0.05; beta=0.99; rho=0.9; phi_y=.5;phi_pinf=1.5;eta_var=0.1;
i_star=(1/beta)-1;
...
figure;
subplot(2,1,1);
plot(a(1)*ones(N,1),'lineWidth',3);
hold on;
plot(a_hat(1,:),'lineWidth',3);
subplot(2,1,2);
plot(a(2)*ones(N,1),'lineWidth',3);
hold on;
plot(a_hat(2,:),'lineWidth',3);
