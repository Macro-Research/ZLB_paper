...
erase_compiled_function('NKPC_REE_Simulation_static');
erase_compiled_function('NKPC_REE_Simulation_dynamic');
M_.orig_eq_nbr = 5;
M_.eq_nbr = 5;
M_.ramsey_eq_nbr = 0;
...
save('NKPC_REE_Simulation_results.mat', 'oo_', 'M_', 'options_');
if exist('estim_params_', 'var') == 1
  save('NKPC_REE_Simulation_results.mat', 'estim_params_', '-append');
end
if exist('bayestopt_', 'var') == 1
  save('NKPC_REE_Simulation_results.mat', 'bayestopt_', '-append');
end
if exist('dataset_', 'var') == 1
  save('NKPC_REE_Simulation_results.mat', 'dataset_', '-append');
end
if exist('estimation_info', 'var') == 1
  save('NKPC_REE_Simulation_results.mat', 'estimation_info', '-append');
end
if exist('dataset_info', 'var') == 1
  save('NKPC_REE_Simulation_results.mat', 'dataset_info', '-append');
end
if exist('oo_recursive_', 'var') == 1
  save('NKPC_REE_Simulation_results.mat', 'oo_recursive_', '-append');
end
