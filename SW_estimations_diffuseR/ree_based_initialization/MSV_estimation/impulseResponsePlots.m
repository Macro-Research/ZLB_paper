clear;clc;%close all;
load('kf_output_workspace_october11.mat');
periods=100;
numPeriods=50;
...
for jj=[1 2 3 4 6 7]
    index=index+1;
subplot(3,2,index);
plot(imp_averaged(70,2:end,6,jj),'--');
hold on;
...
for jj=[1 2 3 4 6 7]
    index=index+1;
subplot(3,2,index);
plot(imp_averaged(70,2:end,7,jj),'--');
hold on;
...
for jj=[1 2 3 4 6 7]
    index=index+1;
subplot(3,2,index);
plot(imp_averaged(70,2:end,8,jj),'--');
hold on;
...
for jj=[1 2 3 4 6 7]
    index=index+1;
subplot(3,2,index);
plot(imp_averaged(70,2:end,10,jj),'--');
hold on;
