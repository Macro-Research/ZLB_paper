clear;clc;%close all;
load('kf_output_workspace_october4.mat');
periods=100;
numPeriods=50;
...
hold on;
plot(imp_averaged(110,2:end,6,jj),'lineWidth',3);
hold on;
...
hold on;
plot(imp_averaged(110,2:end,7,jj),'lineWidth',3);
hold on;
...
hold on;
plot(imp_averaged(110,2:end,8,jj),'lineWidth',3);
hold on;
...
hold on;
plot(imp_averaged(110,2:end,10,jj),'lineWidth',3);
hold on;
