function [ind_para, ind_loglh, ind_post, ind_acpt] = mutation_RWMH(p0, l0, post0, tune, i, f)
...
%post0 = post0+(tune.phi(i)-tune.phi(i-1))*l0;%WHY IS THIS 10??????
post0 = post0+(tune.phi(i)-tune.phi(i-1))*10;%WHY IS THIS 10??????
% Accept/Reject
